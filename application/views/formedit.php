			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('mobil/update/'.$mobil->kdmobil, ['class' => 'form-horizontal', 'method' => 'post']); ?>
						<div class="form-group <?php echo (form_error('kdmobil') != '') ? 'has-error has-feedback' : '' ?>">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="kdmobil" value="<?php echo set_value('kdmobil', $mobil->kdmobil); ?>"
								 readonly>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="jenis" value="<?php echo set_value('jenis', $mobil->jenis); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="tahun" value="<?php echo set_value('tahun', $mobil->tahun); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="harga" value="<?php echo set_value('harga', $mobil->harga); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="nopol" value="<?php echo set_value('nopol', $mobil->nopol); ?>">
